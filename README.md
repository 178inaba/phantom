...
You can start phantom locally by running:
...
Then you can interact with phantom by typing `phantom help`.

    phantom> phantom help
    phantom animate me <query> - The same thing as `image me`, except adds [snip]
    phantom help - Displays all of the help commands that phantom knows about.
    ...
